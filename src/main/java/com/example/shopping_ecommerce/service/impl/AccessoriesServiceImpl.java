...
public class AccessoriesServiceImpl implements AccessoriesService {
    ...
    @Override
    public PagedResponse<ProductResponse> getAllAccessoriesProducts(int page, int size) {

        Category category = categoryRepository.findByName(ACCESSORIES_CATEGORY)
                .orElseThrow(() ->
                        new ResourceNotFoundException("Category not found: " + ACCESSORIES_CATEGORY));
    ...
    @Override
    public ProductResponse getAccessoriesProductById(Long productId) {
        ...
        if (!ACCESSORIES_CATEGORY.equals(product.getCategory().getName())) {
            throw new ResourceNotFoundException(
                    "Product does not belong to Accessories category.");
        }
    ...
    @Override
    public PagedResponse<ProductResponse> searchAccessoriesProducts(
            String keyword,
            int page,
            int size) {
