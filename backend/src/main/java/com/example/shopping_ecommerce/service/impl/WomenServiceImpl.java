...
public class WomenServiceImpl implements WomenService {
    ...
    private static final String WOMEN_CATEGORY = "Women's Wear";

    private final ProductRepository productRepository;
    private final CategoryRepository categoryRepository;

    @Override
    public PagedResponse<ProductResponse> getAllWomenProducts(int page, int size) {

        Category category = categoryRepository.findByName(WOMEN_CATEGORY)
                .orElseThrow(() ->
                        new ResourceNotFoundException("Category not found: " + WOMEN_CATEGORY));
    ...
    @Override
    public ProductResponse getWomenProductById(Long productId) {
        ...
        if (!WOMEN_CATEGORY.equals(product.getCategory().getName())) {
            throw new ResourceNotFoundException(
                    "Product does not belong to Women's Wear category.");
        }
    ...
    @Override
    public PagedResponse<ProductResponse> searchWomenProducts(
            String keyword,
            int page,
            int size) {
