...
<section className="max-w-7xl mx-auto px-6 py-20">
  <div className="flex justify-between items-center mb-10">
    <div>
      <h2 className="text-4xl font-bold text-[#3D2C2E]">Men's Collection</h2>
  ...
  />
      ...
      <section className="py-24 bg-[#F0E6D2]">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <img
            src="https://images.unsplash.com/photo-1490578474895-699cd4e2cf59?w=1200"
            alt=""
          ...
          <div>
            ...
            <p className="text-gray-600 mt-6">
              Discover premium hoodies, jackets,
              denim and sneakers designed for
              everyday confidence.
            </p>
